        ...
        <header class="header">
            <div class="container">
                <div class="header__inner">
                    <!-- Logo -->
                    <a href="./index.jsp" class="header__image">
                        <img
                            class="header__logo"
                    ...
                    <nav class="navbar">
                        ...
                        <ul class="navbar__list">
                            ...
                            <li class="navbar__item">
                                <a href="index.jsp" class="navbar__link"
                                    >Home</a
                                >
                            </li>
                            ...
                            <li class="navbar__item">
                                <a href="${productUrl}" class="navbar__link"
                                    >Shop</a
                                >
                            </li>
                    ...
                    <c:if test="${empty sessionScope.LOGIN}">
                        <div class="header-action">
                            <a href="login.jsp" class="action-link">Login</a>
                            <a href="register.jsp" class="btn action-btn"
                                >Sign up</a
                            >
                        </div>
                    </c:if>
                    ...
                    <c:if test="${not empty sessionScope.LOGIN}">
                        <div class="header-action">
                            ...
                            <c:url var="cart" value="MainController">
                                <c:param name="action" value="CartItem" />
                            </c:url>
