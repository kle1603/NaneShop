...
public class AdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (productId != null && delete == null) {

                boolean checkUpdate = admin.updateProductByAdmin(Integer.parseInt(productId), productName, Integer.parseInt(typeId), Integer.parseInt(quantity), Double.parseDouble(price));
                if (checkUpdate) {
                    ...
                    if (!productList.isEmpty()) {
                        request.setAttribute("ADMIN_PRODUCT_LIST", productList);
                ...
                boolean checkDelete = admin.deleteBreadByAdmin(Integer.parseInt(productId));
                if (checkDelete) {
                    List<ProductDTO> productList = dao.getListProduct(Integer.parseInt(page), PRODUCTS_PER_PAGE, search);
                    int totalProducts = dao.totalProducts;
